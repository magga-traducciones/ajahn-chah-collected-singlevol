...
\renewcommand{\chapterFootnotetext}{\footnotetext{\textit{Note}: This question and answer session was previously published under the same title in `\textit{Bodhinyana}'.}}
